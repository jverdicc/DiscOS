...
- **CI source of truth:** workflow-level `EVIDENCEOS_REPO` (defaults to canonical upstream, overrideable via `vars.EVIDENCEOS_REPO`) and workflow-level `EVIDENCEOS_REV`
